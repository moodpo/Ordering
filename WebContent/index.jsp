				...
				<div class="navbar-inner">
					<div class="container">
						...
						<ul class="nav">
							...
							<li></li>
							<li><a href="<%=path %>/content/ordering.html">订餐</a></li>
						</ul>
						<ul class="nav pull-right">
							<!-- 未登录 -->
							<li><a href="<%=path %>/content/login.html">登录</a></li>
							<li><a href="<%=path %>/content/public/sign.jsp">注册</a></li>
							<li class="divider-vertical"></li>
							<li><a href="<%=path %>/content/help.html">帮助</a></li>
							<li><a href="<%=path %>/content/feedback.html">问题反馈</a></li>
						</ul>
					</div>
				</div>
			</div>
					...
					<div class="row">
						...
						<div class="span5">
							<div id="left-text">
								...
								<div><a class="btn btn-success btn-large"  href="<%=path %>/content/public/sign.jsp">立即注册</a> <a class="btn btn-large" href="<%=path %>/content/login.html">登录</a></div>
							</div>
						</div>
						<!-- /left img span -->
						<!-- right text span -->
					...
					<div class="row">
						...
						<div class="span4">
							<div class="feature-inner">
								...
								<div><a class="btn" href="<%=path %>/content/help.html">查看详情 &rarr;</a></div>
							</div>
						</div>
						<!-- 订单管理 -->
						<div class="span4">
